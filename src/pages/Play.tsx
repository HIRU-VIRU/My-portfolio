...
const SYSTEM_PROMPT = `You are [YOUR NAME], chatting with visitors on your portfolio website.
...
3. If asked about work/projects, share your experiences
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/profile.png" alt="Chess Engine" />
              </div>
              <div className="player-details">
                <span className="player-name">Chess Engine</span>
